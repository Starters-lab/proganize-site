...
export const metadata = {
  title: "Generate Quizzes - Interactive Study Tools",
  description:
    "Transform your study materials into interactive quizzes. Create custom quizzes from PDFs, notes, or topics to prepare smarter and ace your exams with ease.",
  keywords:
    "quiz generator, interactive quizzes, study tools, create quizzes from notes, AI-powered quizzes, custom quizzes, Proganize quizzes",
  openGraph: {
    title: "Generate Quizzes - Interactive Study Tools",
    description:
      "Transform your study materials into interactive quizzes. Create custom quizzes from PDFs, notes, or topics to prepare smarter and ace your exams with ease.",
    type: "website",
    url: "https://prorganize.app/quiz-generator",
    images: [
      {
        url: "/socialscreen-quizzes.png", // Add this image to your public folder
        width: 1200,
        height: 630,
        alt: "Generate Quizzes with Proganize",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Transform your study materials into interactive quizzes. Create custom quizzes from PDFs, notes, or topics to prepare smarter and ace your exams with ease.",
    images: ["/og-image-quizzes.jpg"], // Same image as OpenGraph
  },
};
          ...
          <div className='flex flex-col items-center space-y-4 text-center'>
            <div className='space-y-6 max-w-3xl'>
              ...
              <p className='mx-auto text-lg text-muted-foreground md:text-xl'>
                Create personalized quizzes in seconds from your notes,
                lectures, or PDFs to test your knowledge and prepare like a pro.
                Proganize makes learning interactive and effective.
              </p>
            </div>
            <div className='mt-8'>
