                ...
                {activeTab === "privacy" ? (
                  <div className='space-y-6'>
                    ...
                    <section>
                      ...
                      <ul className='list-disc pl-6 space-y-2'>
                        <li>
                          ...
                          register for an account, we collect personal details
                          such as your name, email address, and any other
                          information necessary to provide our services.
                        </li>
                        <li>
                          <strong>Document Data:</strong> Any documents or
                          content you upload, create, or collaborate on within
                          Proganize.
                        </li>
                        <li>
                          <strong>Usage Data:</strong> Information about how you
                          use Proganize, including login details, IP address,
                          and browser information.
                        </li>
                        <li>
                          <strong>Payment Information:</strong> For paid users,
                          we may collect and process payment details through
                    ...
                    <section>
                      ...
                      <ul className='list-disc pl-6 space-y-2'>
                        <li>
                          ...
                          parties like Supabase, Stripe, and OpenAI for
                          essential services like authentication, payments, and
                          AI-based features.
                        </li>
                        <li>
                          <strong>Legal Authorities:</strong> If required by law
                          or in the case of legal processes, such as subpoenas
                          or court orders.
                        </li>
                      </ul>
                    </section>
                    ...
                    <section>
                      ...
                      <p>
                        We implement measures to safeguard your data. However,
                    ...
                    <section>
                      ...
                      <p>
                        You can access, modify, or delete your account
                        information at any time by logging into your account
                        settings. If you wish to delete your account entirely,
                        please contact us.
                      </p>
                    </section>
                    ...
                    <section>
                      ...
                      <p>
                        ...
                        you of any changes by posting the new policy on our
                        site, and the effective date will be updated
                        accordingly.
                      </p>
                    </section>
                  ...
                  <div className='space-y-6'>
                    ...
                    <section>
                      ...
                      <p>
                        ...
                        registering an account, you confirm that you are of
                        legal age.
                      </p>
                    </section>
                    ...
                    <section>
                      ...
                      <p>
                        Proganize allows users to create, upload, and
                        collaborate on documents. You are solely responsible for
                        the content you create or share. You agree not to:
                      </p>
                      <ul className='list-disc pl-6 space-y-2'>
                        <li>
                    ...
                    <section>
                      ...
                      <ul className='list-disc pl-6 space-y-2'>
                        <li>
                          <strong>Free Plan:</strong> Users can create
                          documents, chat with the document (with a conversation
                          limit), and invite up to 3 collaborators.
                        </li>
                        <li>
                          ...
                          advanced features such as add-ons (user stories,
                          product roadmaps, etc.) and document uploads for AI
                          enhancement.
                        </li>
                      </ul>
                      <p>
                    ...
                    <section>
                      ...
                      <p>
                        You may terminate your account at any time. We reserve
                        the right to terminate or suspend accounts at our
                        discretion, particularly for breaches of these Terms.
                      </p>
                    </section>
                    ...
                    <section>
                      ...
                      <p>
                        ...
                        use of Proganize. Our total liability shall not exceed
                        the amount you paid to us in the last 12 months for the
                        service.
                      </p>
                    </section>
